...
const zipfile= ()=>{
  ...
  window.location.href = "/zipmaster/"+token;
    setViewConverted(true);
...
const clinicmaster= ()=>{
  ...
  window.location.href = "/clinicmaster/"+token;
    setViewConverted(true);
...
const users= ()=>{
  ...
  window.location.href = "/usersall/"+token;
    setViewConverted(true);
...
const navigatDoctor= ()=>{
  ...
  window.location.href = "/doctorview/"+token;
...
<aside id="sidebar" className="sidebar" style={active ? {marginLeft:"-300px"}: {marginLeft:"3px"}} >
           ...
           <ul className="sidebar-nav" id="sidebar-nav">
             ...
             <li className="nav-item" onClick={vbgFileView}>
               <Link onClick={dashboard}  className= {`${viewConverted ? "nav-link collapsed" : "nav-link collapsed"}`} to={`/dashboard/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoiNjMwY2Q3Y2QwYjVjY2I5NmZmNzVhZTc3IiwiaWF0IjoxNjYxOTUxODk3LCJleHAiOjE2OTM0ODc4OTd9.wT14X6DiLHTwpmyNFRejbr9LAAtHLUK7ha18pAlLBGY`}>
             ...
             {/* <li className="nav-item" onClick={flexFileView}>
               <Link onClick={dashboard}   className=  {`${viewConverted ? "nav-link collapsed" : "nav-link"}`}
        data-bs-target="#icons-nav" data-bs-toggle="collapse" to="#">
             ...
             <li  className=  "nav-link collapsed" onClick={zipfile} >
